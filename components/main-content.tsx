...
export default function MainContent({ location, locationName, filters }: MainContentProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full lg:h-full bg-gray-50 lg:overflow-hidden">
      <div className="hidden lg:block lg:w-[42%] h-64 sm:h-96 md:h-[500px] lg:h-full bg-gray-200 relative z-0 isolate">
        <Map
      ...
      <div className="w-full lg:w-[58%] lg:h-full flex flex-col bg-white shadow-inner lg:overflow-hidden">
        <ListingsPanel
